...
public class CannonBall : MonoBehaviour
{
    ...
    private void OnTriggerEnter(Collider collision)
    {
        if (collision.gameObject.tag == "Enemy" & collision.gameObject != _owner)
        {
            ...
            {
                _owner.GainXP(collision.gameObject.GetComponent<ProjetPirate.IA.Shark_Character>().Damage(_damage));
            ...
            {
                _owner.GainXP(collision.gameObject.GetComponent<ProjetPirate.IA.Ship_Character>().Damage(_damage));
