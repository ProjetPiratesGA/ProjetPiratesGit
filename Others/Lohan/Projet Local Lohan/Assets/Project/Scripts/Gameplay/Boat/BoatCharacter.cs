...
namespace ProjetPirate.Boat
{
    ...
    public class BoatCharacter : ProjetPirate.IA.Character
    {
        ...
        [Header("CANNONS")]
        [SerializeField] public List<Cannon> _larboardCannons;
        [SerializeField] public List<Cannon> _starboardCannons;
        ...
        void Update()
        {
            ...
            {
                _currentLifePoint = MaxLifePoint / 2;
                Debug.Log("paflavie");
            }
        }
        ...
        public void SetUpBoat(Player _player)
        {
            ...
            for (int i = 0; i < this.DefaultCannonNumberBySide; i++)
            {
                ...
                CannonHarpoon cannonHarpoon = Instantiate(_prowCannonHarpoonPrefab).GetComponent<CannonHarpoon>();
                cannonHarpoon.gameObject.transform.SetParent(_prowCannonHarpoonPosition);
