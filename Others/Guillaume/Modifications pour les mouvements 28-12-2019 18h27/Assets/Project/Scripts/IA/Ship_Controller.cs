...
namespace ProjetPirate.IA
{
    ...
    public class Ship_Controller : IA_Controller
    {
        ...
        [SerializeField] protected BoatCharacter _character;
        ...
        {
            PlankOnSea.SpawnPlank(_character._droppedPlank, this.transform.position, _character._plankDroppedByDeath);
            Chest.SpawnChest(_character.DroppedChest, this.transform.position, _character._moneyDroppedByDeath, 0);
