...
namespace ProjetPirate.Physic
{
    ...
    public class Waves2 : MonoBehaviour
    {
        ...
        {
            //setup the mesh
            if (this.GetComponent<Mesh>() != null)
            {
                _mesh = this.GetComponent<Mesh>();
                ...
                {
                    Debug.LogError(this.name + " pas de meshFilter");
                }
            }
            else
            {
                Debug.LogError(this.name + " pas de mesh");
            }
        ...
        private void ManipulateVertices()
        {
            ...
            {
                Debug.LogError(this.name + " _mesh.vertices == null");
            }
