...
namespace ProjetPirate.IA
{
    public class Patrol_Checkpoint : IA_Patrol
    {
        ...
        [SerializeField] public List<Transform> _checkpoints;
        ...
        public float FinalWaitingTime
        {
            set { _finalWaitingTime = value; }
        }
        ...
        public override Vector3 Patrol()
        {
            ...
            else
            {
                ...
                {
                    if (_nextCheckpointId == _checkpoints.Count - 1 | (_isReversed & _nextCheckpointId == 0))
                    {
                        _willWait = (_finalWaitingTime != 0);

                    }
                    else
                    {
                        _willWait = (_standardWaitingTime != 0);
                    }
